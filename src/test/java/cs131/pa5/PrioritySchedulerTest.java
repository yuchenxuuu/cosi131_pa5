...
import cs131.pa5.Abstract.Log.Event;
...
public class PrioritySchedulerTest {
    ...
    public void PreemptivePriorityManyTunnels() {
    	List<Thread> vehicleThreads = new ArrayList<Thread>();
    	Scheduler preemptivePriorityScheduler = setupPreemptivePrioritySchedulerTwoTunnels(TestUtilities.mrNames[0], TestUtilities.mrNames[1]);
